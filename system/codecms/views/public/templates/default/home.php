...
<div class="jumbotron">
  <h1>Code CMS!</h1>
  <p class="lead">CodeCMS is a pet project of <a href="http://jsdecena.me">Jeff Simons Decena.</a> It aims to be an alternative <u>open source</u> CMS software made from Manila, Philippines. Currently, this is ver 0.1 stable release. <br /> You can contribute on this project by forking <a href="https://bitbucket.org/jsdecena/codecms">this.</a></p>
