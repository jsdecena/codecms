...
class Admin_posts extends CI_Controller {    
    ...
    public function posts_list($post_type= 'post'){
    ...
    public function post_create_check(){
        ...
        if ( $this->form_validation->run() ) :
            ...
            if ( $this->input->post('post_create') && $this->posts_model->insert_post() === TRUE ) :
                ...
                redirect('admin/admin_posts/post_edit' .'/'. $this->posts_model->get_post_id(), $data);    
    ...
    public function post_edit_check(){
        ...
        if ( $this->form_validation->run() ) :
            ...
            redirect('admin/admin_posts/post_edit' .'/'. $this->input->post('post_id'), $data);
    ...
    public function quick_update(){
        ...
        if ( $this->users_model->logged_in_check() ) :
            ...
            if ( $this->posts_model->quick_update() ) :
                ...
                redirect('admin/admin_posts/posts_list');
    ...
    public function post_delete(){
        ...
        if( $this->posts_model->delete_post() === TRUE) :
           ...
           redirect('admin/admin_posts/posts_list', $data);
